...
namespace Builder
{
    class Program
    {
        ...
        {
            public override void BuildDough() { pizza.SetDough("mild"); }
            public override void BuildSauce() { pizza.SetSauce("tasty"); }
            public override void BuildTopping() { pizza.SetTopping("cheese"); }
        }
        /** "Director" */
        class Waiter
        {
